import {
  ...
  CheckCircle2, ChevronDown, ChevronLeft, ChevronRight, Circle, ClipboardList, Clock, Compass, Cpu,
  ...
  TrendingUp, Trash2, Trophy, Underline, Upload, User, Users, Wrench, X, Zap,
} from "lucide-react";
...
const ICONS = {
  ...
  clipboard: ClipboardList, clock: Clock, compass: Compass, cpu: Cpu, download: Download, eye: Eye,
  ...
  trophy: Trophy, underline: Underline, upload: Upload, user: User, users: Users, wrench: Wrench, x: X,
  zap: Zap,
} as const;
